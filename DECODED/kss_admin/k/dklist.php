...
function _obfuscate_iJCMj42PlYiUiIeQlJOIjYsÿ( $_obfuscate_jpKPlJSUiZOHkYaPlIeOiY4ÿ = 1 )
{
...
$_obfuscate_lJSNlZWKlYmGi4iSkIqHjpAÿ = "from `kss_z_client_".$_obfuscate_lI6OiJSPjZWVi5GQhoiPjpUÿ['pid']."_".$_obfuscate_jpKNh4aRh4aQkY2PlIuRhpEÿ."` ";
...
echo "</td>\r\n</tr>\r\n</table>\r\n\r\n<table class=\"listtable\" border=\"0\" cellspacing=\"1\" cellpadding=\"0\" align=\"center\" width=\"99%\">\r\n<tr class=\"trhead\">\r\n<td nowrap=\"nowrap\">åœ¨çº¿çŠ¶æ€</td>\t\r\n";
...
echo "<td nowrap=\"nowrap\" malt=\"è¯¥æ¡è®°å½•ä½¿ç”¨çš„é€šé“å·ï¼Œä¹Ÿå°±æ˜¯è€çš„å®¢æˆ·ç«¯ID\">é€šé“å·</td>\t\t\r\n<td nowrap=\"nowrap\" malt=\"ä¸Šæ¬¡ä½¿ç”¨æœ¬ç”¨æˆ·è¯¥é€šé“å·çš„ç”µè„‘ç‰¹å¾ç \">æœºå™¨ç </td>\r\n<td nowrap=\"nowrap\" malt=\"ä¿è¯å”¯ä¸€åœ¨çº¿çš„åœ¨çº¿ç \">åœ¨çº¿ç </td>\r\n<td nowrap=\"nowrap\" malt=\"ä¸Šä¸€æ¬¡è¿æ¥æœåŠ¡å™¨éªŒè¯çš„æ—¶é—´\">ä¸Šä¸€æ¬¡åœ¨çº¿</td>\r\n<td nowrap=\"nowrap\" malt=\"ä¸Šä¸€æ¬¡è¿æ¥æœåŠ¡å™¨çš„IP\">IP</td>\r\n<td nowrap=\"nowrap\" malt=\"å¯é€šè¿‡advapiæ¥å£æ¥æ“ä½œ\">ç§æœ‰æ•°æ®</td>\r\n</tr>\r\n";
if ( empty( $_obfuscate_iYeIjIaVlYaIj4yTiJWHk40ÿ ) )
{
    echo "<tr nodata=1 class=trd><td colspan=8>æ²¡æ‰¾åˆ°ç”¨æˆ·ç›¸å…³é€šé“æ•°æ®</td></tr>";
}
else
{
    foreach ( $_obfuscate_iYeIjIaVlYaIj4yTiJWHk40ÿ as $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ )
    {
        ...
        echo "'>";
        if ( $_obfuscate_jZGRipSRkIeUiIeQjoaUjJIÿ['chkonline'] == 0 )
        {
            $_obfuscate_jpKIj4yRlZGKjYmOioqHjpQÿ = time( ) < $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ['lasttime'] + 60 * $_obfuscate_jZGRipSRkIeUiIeQjoaUjJIÿ['unbindpc_autotime'] ? "'online1' title='åœ¨çº¿'" : "'online0' title='ä¸åœ¨çº¿'";
        }
        else if ( $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ['isonline'] == 1 )
        {
            if ( time( ) < $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ['lasttime'] + 60 * $_obfuscate_jZGRipSRkIeUiIeQjoaUjJIÿ['outlinetime'] )
            {
                $_obfuscate_jpKIj4yRlZGKjYmOioqHjpQÿ = "'online2' title='åœ¨çº¿ï¼Œå•å‡»å¯å¼ºåˆ¶è®¾ç½®ä¸ºç¦»çº¿'";
            }
            else
            {
                $_obfuscate_jpKIj4yRlZGKjYmOioqHjpQÿ = "'online3' title='åœ¨çº¿ï¼Œå•å‡»å¯å¼ºåˆ¶è®¾ç½®ä¸ºç¦»çº¿'";
            }
        }
        else
        {
            $_obfuscate_jpKIj4yRlZGKjYmOioqHjpQÿ = "'online0' title='ä¸åœ¨çº¿'";
        }
        echo "<td nowrap='nowrap'><span class=".$_obfuscate_jpKIj4yRlZGKjYmOioqHjpQÿ." cid=";
        echo $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ['clientid'];
        echo ">â—†</span></td><td nowrap='nowrap'>";
        echo _obfuscate_j5CKkY_GkomSkoaUlIuLlYkÿ( $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ['username'] );
        echo "</td><td nowrap='nowrap'>";
        echo $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ['clientid'];
        echo "</td><td nowrap='nowrap'>";
        echo _obfuscate_j5CKkY_GkomSkoaUlIuLlYkÿ( $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ['pccode'] );
        echo "</td><td nowrap='nowrap'>";
        echo $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ['linecode'];
        echo "</td><td nowrap='nowrap'>";
        echo _obfuscate_jZGJkpOSkY_HiY2HjY2JlIgÿ( $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ['lasttime'], "m-d H:i:s" );
        echo "</td><td nowrap='nowrap' class=isip>";
        echo long2ip( $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ['lastip'] );
        echo "</td><td nowrap='nowrap'>";
        echo _obfuscate_j5CKkY_GkomSkoaUlIuLlYkÿ( $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ['updata'] );
        echo "</td></tr>\r\n";
    }
}
echo "</table>\r\n<table class=\"listtable\" border=\"0\" cellspacing=\"1\" cellpadding=\"0\" align=\"center\" width=\"99%\">\r\n<tr>\r\n<td class=\"findorpage\">";

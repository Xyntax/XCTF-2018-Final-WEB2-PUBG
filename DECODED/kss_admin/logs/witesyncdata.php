...
function _obfuscate_i4yGkIiUio6Pi4mHi5WIlYgÿ( $_obfuscate_jpKPlJSUiZOHkYaPlIeOiY4ÿ = 1 )
{
...
$_obfuscate_lJSNlZWKlYmGi4iSkIqHjpAÿ = "from `kss_tb_sql` ";
...
echo "</td>\r\n</tr>\r\n</table>\r\n<table class=\"listtable\" border=\"0\" cellspacing=\"1\" cellpadding=\"0\" align=\"center\" width=\"97%\">\r\n<tr class=\"trhead\">\r\n<td malt=\"IDå·\">ID</td>\r\n<td malt=\"è®°å½•ç±»å‹\">Type</td>\r\n<td malt=\"è®°å½•äº§ç”Ÿçš„æ—¥æœŸ\">Date</td>\r\n<td malt=\"éœ€åŒæ­¥åˆ°å¤‡æœçš„SQLè¯­å¥\">SQL</td>\r\n</tr>\r\n";
if ( empty( $_obfuscate_iYeIjIaVlYaIj4yTiJWHk40ÿ ) )
{
    echo "<tr class=trd><td colspan=4>æ²¡æœ‰éœ€åŒæ­¥çš„æ•°æ®</td></tr>";
}
else
{
    foreach ( $_obfuscate_iYeIjIaVlYaIj4yTiJWHk40ÿ as $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ )
    {
        ...
        echo "</td>\r\n<td nowrap=\"nowrap\">";
        echo $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ['isact'];
        echo "</td>\r\n<td nowrap=\"nowrap\">";
        echo _obfuscate_jZGJkpOSkY_HiY2HjY2JlIgÿ( $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ['addtime'] );
        echo "</td>\r\n<td>";
        echo htmlspecialchars( $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ['sqltext'] );
        echo "</td>\r\n</tr>\r\n";
    }
}
echo "</table>\r\n<table class=\"listtable\" border=\"0\" cellspacing=\"1\" cellpadding=\"0\" align=\"center\" width=\"97%\">\r\n<tr>\r\n<td class=\"findorpage\">";

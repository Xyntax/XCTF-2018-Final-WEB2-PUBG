...
function _obfuscate_kYeIjo2OipCRkYyUjJCQko8ÿ( $_obfuscate_jpKPlJSUiZOHkYaPlIeOiY4ÿ = 1 )
{
...
else
{
    ...
    $_obfuscate_jIqTkJSOiYyIk5WJjIuJiYkÿ = 0;
    $_obfuscate_kYmHlZCUhpSMkpCPiY6Shogÿ = array( );
    $_obfuscate_kZCRjYuGiIuGi5WJlIaKiZMÿ = $_obfuscate_jIaUiIeSjZWKlIqLkIqOiocÿ->_obfuscate_lZGTiIiKhouKiZGLi5KUkI8ÿ( "select `id`,`username`,`pid`,`isdel` from `kss_tb_manager` where `pid`=".$_obfuscate_lI6OiJSPjZWVi5GQhoiPjpUÿ['pid'] );
    foreach ( $_obfuscate_kZCRjYuGiIuGi5WJlIaKiZMÿ as $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ )
    {
        if ( $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ['id'] == $_obfuscate_kYqTiZWUjZKLjZCVlImUi5Aÿ )
        {
            $_obfuscate_jIqTkJSOiYyIk5WJjIuJiYkÿ = 1;
            $_obfuscate_kYmHlZCUhpSMkpCPiY6Shogÿ[$_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ['id']] = $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ['username'];
        }
    }
    if ( $_obfuscate_jIqTkJSOiYyIk5WJjIuJiYkÿ == 0 )
    {
        _obfuscate_kYyOhouLjo2Gh4eNj4iQlIgÿ( "ä½ æ‰€æŸ¥è¯¢çš„ç”¨æˆ·æ²¡æ‰¾åˆ°ï¼Œæˆ–ä½ æ— æƒæŸ¥è¯¢è¯¥ç”¨æˆ·çš„ç™»é™†æ—¥å¿—ï¼" );
    }
}
...
$_obfuscate_lJSNlZWKlYmGi4iSkIqHjpAÿ = "from `kss_tb_log_login` ";
...
{
    $_obfuscate_j4mJh4aKjZKHhpOSiJKSjJIÿ = " where".implode( " and ", $_obfuscate_h4eJlYuIjpKNio6QkIuJlIYÿ )." order by logintime desc";
}
...
if ( $_obfuscate_iIiHi4aTkoySkpCNio_UjYoÿ != "" )
{
    ...
    $_obfuscate_iYeIjIaVlYaIj4yTiJWHk40ÿ = $_obfuscate_jIaUiIeSjZWKlIqLkIqOiocÿ->_obfuscate_lZGTiIiKhouKiZGLi5KUkI8ÿ( $_obfuscate_jpCQi4aKkYaIjpSUhpWNipMÿ.$_obfuscate_lJSNlZWKlYmGi4iSkIqHjpAÿ.$_obfuscate_homTioySho6Vh5ORiYmUkokÿ." order by id desc" );
}
$_obfuscate_lJKOiJSHjo_Sj4yKk4aIh5Iÿ[] = _obfuscate_hpCTj4mKj5WSkpWPjouJkocÿ( );
...
if ( 7 < $_obfuscate_lI6OiJSPjZWVi5GQhoiPjpUÿ['level'] )
{
    ...
    foreach ( $_obfuscate_kZCRjYuGiIuGi5WJlIaKiZMÿ as $_obfuscate_ipWMj4mQkZSRi5KKkJOQlY8ÿ )
    {
        if ( $_obfuscate_ipWMj4mQkZSRi5KKkJOQlY8ÿ['isdel'] == 0 )
        {
            ...
            echo ">".$_obfuscate_ipWMj4mQkZSRi5KKkJOQlY8ÿ['username']."</option>";
        }
    }
    echo "</select><input type=submit class=submitbtn value=\"æŸ¥è¯¢\">\r\n</form></td>\r\n</tr>\r\n</table>\r\n";
}
...
{
    echo "<tr class=trd><td colspan=5>æ²¡æœ‰ç™»é™†è®°å½•</td></tr>";
}
else
{
    foreach ( $_obfuscate_iYeIjIaVlYaIj4yTiJWHk40ÿ as $_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ )
    {
        ...
        echo "</td>\r\n<td>";
        echo isset( $_obfuscate_kYmHlZCUhpSMkpCPiY6Shogÿ[$_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ['managerid']] ) ? $_obfuscate_kYmHlZCUhpSMkpCPiY6Shogÿ[$_obfuscate_kY_OlYeUlIiVjo6Hio_MkpIÿ['managerid']] : "&nbsp;";
        echo "</td>\r\n<td>";
